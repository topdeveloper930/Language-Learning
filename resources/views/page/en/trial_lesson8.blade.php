...
<div class="modal-page">
	...
	<a href="{{  route('page', ['controller' => 'trial-lesson', 'id' => 4]) }}" class="action left"><i class="far fa-long-arrow-left"></i> Learning style (1 of 2)</a>
	...
	<div class="modal-page-box sm">
		...
		<header>
			...
			<h1 class="modal-title">Learning style (2 of 2)</h1>
			<p class="modal-subtitle">We'd like to know more about how you learn best.</p>
		</header>

		<form action="{{  route('page', ['controller' => 'trial-lesson', 'id' => 5]) }}" method="">
			...
			<div class="form-group">
				...
				<a href="{{  route('page', ['controller' => 'trial-lesson', 'id' => 5]) }}" class="button primary">Submit (blacklist example)</a><br><br>
				<a href="{{  route('page', ['controller' => 'trial-lesson', 'id' => 6]) }}" class="button primary">Submit</a>
			</div>
		</form>
