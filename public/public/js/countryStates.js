...
/***/ "./resources/assets/js/modules/countryStates.js":
/*!******************************************************!*\
  !*** ./resources/assets/js/modules/countryStates.js ***!
  \******************************************************/
...
var country_arr = new Array("Afghanistan", "Albania", "Algeria", "American Samoa", "Angola", "Anguilla", "Antartica", "Antigua and Barbuda", "Argentina", "Armenia", "Aruba", "Ashmore and Cartier", "Australia", "Austria", "Azerbaijan", "Bahamas", "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "Bolivia", "Bosnia and Herzegovina", "Botswana", "Brazil", "British Virgin Islands", "Brunei", "Bulgaria", "Burkina Faso", "Burma", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Cayman Islands", "Central African Republic", "Chad", "Chile", "China", "Christmas Island", "Clipperton Island", "Cocos (Keeling) Islands", "Colombia", "Comoros", "Congo, Democratic Republic of the", "Congo, Republic of the", "Cook Islands", "Costa Rica", "Cote d'Ivoire", "Croatia", "Cuba", "Cyprus", "Czeck Republic", "Denmark", "Djibouti", "Dominica", "Dominican Republic", "Ecuador", "Egypt", "El Salvador", "Equatorial Guinea", "Eritrea", "Estonia", "Ethiopia", "Europa Island", "Falkland Islands (Islas Malvinas)", "Faroe Islands", "Fiji", "Finland", "France", "French Guiana", "French Polynesia", "French Southern and Antarctic Lands", "Gabon", "Gambia, The", "Gaza Strip", "Georgia", "Germany", "Ghana", "Gibraltar", "Glorioso Islands", "Greece", "Greenland", "Grenada", "Guadeloupe", "Guam", "Guatemala", "Guernsey", "Guinea", "Guinea-Bissau", "Guyana", "Haiti", "Heard Island and McDonald Islands", "Holy See (Vatican City)", "Honduras", "Hong Kong", "Howland Island", "Hungary", "Iceland", "India", "Indonesia", "Iran", "Iraq", "Ireland", "Ireland, Northern", "Israel", "Italy", "Jamaica", "Jan Mayen", "Japan", "Jarvis Island", "Jersey", "Johnston Atoll", "Jordan", "Juan de Nova Island", "Kazakhstan", "Kenya", "Kiribati", "Korea, North", "Korea, South", "Kuwait", "Kyrgyzstan", "Laos", "Latvia", "Lebanon", "Lesotho", "Liberia", "Libya", "Liechtenstein", "Lithuania", "Luxembourg", "Macau", "Macedonia, Former Yugoslav Republic of", "Madagascar", "Malawi", "Malaysia", "Maldives", "Mali", "Malta", "Man, Isle of", "Marshall Islands", "Martinique", "Mauritania", "Mauritius", "Mayotte", "Mexico", "Micronesia", "Midway Islands", "Moldova", "Monaco", "Mongolia", "Montserrat", "Morocco", "Mozambique", "Namibia", "Nauru", "Nepal", "Netherlands", "Netherlands Antilles", "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "Niue", "Norfolk Island", "Northern Mariana Islands", "Norway", "Oman", "Pakistan", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Pitcaim Islands", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", "Romania", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", "Saint Pierre and Miquelon", "Saint Vincent and the Grenadines", "Samoa", "San Marino", "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles", "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Solomon Islands", "Somalia", "South Africa", "South Georgia and South Sandwich Islands", "Spain", "Spratly Islands", "Sri Lanka", "Sudan", "Suriname", "Svalbard", "Swaziland", "Sweden", "Switzerland", "Syria", "Taiwan", "Tajikistan", "Tanzania", "Thailand", "Tobago", "Toga", "Tokelau", "Tonga", "Trinidad", "Tunisia", "Turkey", "Turkmenistan", "Tuvalu", "Uganda", "Ukraine", "United Arab Emirates", "United Kingdom", "Uruguay", "USA", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Virgin Islands", "Wales", "Wallis and Futuna", "West Bank", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zimbabwe");
var s_a = new Array();
s_a[0] = "";
s_a[1] = "Badakhshan|Badghis|Baghlan|Balkh|Bamian|Farah|Faryab|Ghazni|Ghowr|Helmand|Herat|Jowzjan|Kabol|Kandahar|Kapisa|Konar|Kondoz|Laghman|Lowgar|Nangarhar|Nimruz|Oruzgan|Paktia|Paktika|Parvan|Samangan|Sar e Pol|Takhar|Vardak|Zabol";
s_a[2] = "Berat|Bulqize|Delvine|Devoll|Diber|Durres|Elbasan|Fier|Gjirokaster|Gramsh|Has|Kavaje|Kolonje |Korce|Kruje|Kucove|Kukes|Kurbin|Lezhe|Librazhd|Lushnje|Malesi e Madhe|Mallakaster|Mat|Mirdite|Peqin|Permet|Pogradec|Puke|Sarande|Shkoder|Skrapar |Tepelene|Tirane |Tirane |Tropoje |Vlore";
...
s_a[4] = "Eastern|Manua|Rose|Swains|Western";
...
s_a[16] = "Acklins and Crooked|Bimini|Cat|Exuma|Freeport|Fresh Creek|Governors Harbour|Green Turtle Cay|Harbour|High Rock|Inagua|Kemps Bay|Long|Marsh Harbour|Mayaguana|New Providence|Nicholls Town and Berry|Ragged|Rock Sound|San Salvador and Rum Cay|Sandy Point";
...
s_a[20] = "Brestskaya|Homyelskaya|Horad Minsk|Hrodzyenskaya|Mahilyowskaya|Minskaya|Vitsyebskaya";
...
s_a[36] = "Banteay Mean Cheay|Batdambang|Kampong Cham|Kampong Chhnang|Kampong Spoe|Kampong Thum|Kampot|Kandal|Kaoh Kong|Keb|Kracheh|Mondol Kiri|Otdar Mean Cheay|Pailin|Phnum Penh|Pouthisat|Preah Seihanu|Preah Vihear|Prey Veng|Rotanah Kiri|Siem Reab|Stoeng Treng|Svay Rieng|Takev";
...
s_a[44] = "Anhui|Beijing|Chongqing|Fujian|Gansu|Guangdong|Guangxi|Guizhou|Hainan|Hebei|Heilongjiang|Henan|Hubei|Hunan|Jiangsu|Jiangxi|Jilin|Liaoning|Nei Mongol|Ningxia|Qinghai|Shaanxi|Shandong|Shanghai|Shanxi|Sichuan|Tianjin|Xinjiang|Xizang|Yunnan|Zhejiang";
s_a[45] = "Christmas Island";
s_a[46] = "Clipperton Island";
s_a[47] = "Direction|Home|Horsburgh|North Keeling|South|West";
s_a[48] = "Amazonas|Antioquia|Arauca|Atlantico|Bolivar|Boyaca|Caldas|Caqueta|Casanare|Cauca|Cesar|Choco|Cordoba|Cundinamarca|Distrito Capital de Santa Fe de Bogota|Guainia|Guaviare|Huila|La Guajira|Magdalena|Meta|Narino|Norte de Santander|Putumayo|Quindio|Risaralda|San Andres y Providencia|Santander|Sucre|Tolima|Valle del Cauca|Vaupes|Vichada";
s_a[49] = "Anjouan|Domoni|Fomboni|Grande Comore|Moheli|Moroni|Moutsamoudou";
...
s_a[52] = "Aitutaki|Atiu|Avarua|Mangaia|Manihiki|Manuae|Mauke|Mitiaro|Nassau|Palmerston|Penrhyn|Pukapuka|Rakahanga|Rarotonga|Suwarrow|Takutea";
...
s_a[64] = "Ad Daqahliyah|Al Bahr al Ahmar|Al Buhayrah|Al Fayyum|Al Gharbiyah|Al Iskandariyah|Al Ismailiyah|Al Jizah|Al Minufiyah|Al Minya|Al Qahirah|Al Qalyubiyah|Al Wadi al Jadid|As Suways|Ash Sharqiyah|Aswan|Asyut|Bani Suwayf|Bur Said|Cairo|Dumyat|Janub Sina|Kafr ash Shaykh|Matruh|Qina|Shamal Sina|Suhaj";
...
s_a[68] = "Harjumaa|Hiiumaa|Ida Virumaa|Jarvamaa|Jogevamaa|Laane Virumaa|Laanemaa|Parnumaa|Polvamaa|Raplamaa|Saaremaa|Tartumaa|Valgamaa|Viljandimaa|Vorumaa";
s_a[69] = "Adis Abeba|Afar|Amara|Dire Dawa|Gambela Hizboch|Hareri Hizb|Oromiya|Sumale|Tigray|YeDebub Biheroch Bihereseboch na Hizboch";
s_a[70] = "Europa Island";
s_a[71] = "Falkland Islands";
...
s_a[81] = "Gaza Strip";
s_a[82] = "Abashis|Abkhazia or Apkhazetis Avtonomiuri Respublika|Adigenis|Ajaria or Acharis Avtonomiuri Respublika |Akhalgoris|Akhalkalakis|Akhaltsikhis|Akhmetis|Ambrolauris|Aspindzis|Baghdatis|Bolnisis|Borjomis|Chkhorotsqus|Chokhatauris|Chiatura|Dedoplistsqaros|Dmanisis|Dushetis|Gardabanis|Gori|Goris|Gurjaanis|Javis|Karelis|Kutaisi|Kaspis|Kharagaulis|Khashuris|Khobis|Khonis|Lagodekhis|Lanchkhutis|Lentekhis|Marneulis|Martvilis|Mestiis|Mtskhetis|Ninotsmindis|Onis|Ozurgetis|Poti|Qazbegis|Qvarlis|Rustavi|Sachkheris|Sagarejos|Samtrediis|Senakis|Sighnaghis|Tbilisi|Telavis|Terjolis|Tetritsqaros|Tianetis|Tqibuli|Tsageris|Tsalenjikhis|Tsalkis|Tsqaltubo|Vanis|Zestaponis|Zugdidi|Zugdidis";
...
s_a[87] = "Aitolia kai Akarnania|Akhaia|Argolis|Arkadhia|Arta|Attiki|Ayion Oros |Dhodhekanisos|Drama|Evritania|Evros|Evvoia|Florina|Fokis|Fthiotis|Grevena|Ilia|Imathia|Ioannina|Irakleion|Kardhitsa|Kastoria|Kavala|Kefallinia|Kerkyra|Khalkidhiki|Khania|Khios|Kikladhes|Kilkis|Korinthia|Kozani|Lakonia|Larisa|Lasithi|Lesvos|Levkas|Magnisia|Messinia|Pella|Pieria|Preveza|Rethimni|Rodhopi|Samos|Serrai|Thesprotia|Thessaloniki|Trikala|Voiotia|Xanthi|Zakinthos";
s_a[88] = "Avannaa|Kitaa|Tunu";
...
s_a[96] = "Barima Waini|Cuyuni Mazaruni|Demerara Mahaica|East Berbice Corentyne|Essequibo West Demerara|Mahaica Berbice|Pomeroon Supenaam|Potaro Siparuni|Upper Demerara Berbice|Upper Takutu Upper Essequibo";
...
s_a[105] = "Andaman and Nicobar|Andhra Pradesh|Arunachal Pradesh|Assam|Bihar|Chandigarh|Chhattisgarh|Dadra and Nagar Haveli|Daman and Diu|Delhi|Goa|Gujarat|Haryana|Himachal Pradesh|Jammu and Kashmir|Jharkhand|Karnataka|Kerala|Lakshadweep|Madhya Pradesh|Maharashtra|Manipur|Meghalaya|Mizoram|Nagaland|Orissa|Pondicherry|Punjab|Rajasthan|Sikkim|Tamil Nadu|Tripura|Uttar Pradesh|Uttaranchal|West Bengal";
...
s_a[123] = "Abaiang|Abemama|Aranuka|Arorae|Banaba|Banaba|Beru|Butaritari|Central Gilberts|Gilbert|Kanton|Kiritimati|Kuria|Line|Line |Maiana|Makin|Marakei|Nikunau|Nonouti|Northern Gilberts|Onotoa|Phoenix|Southern Gilberts|Tabiteuea|Tabuaeran|Tamana|Tarawa|Tarawa|Teraina";
s_a[124] = "Chagang do|Hamgyong bukto|Hamgyong namdo|Hwanghae bukto|Hwanghae namdo|Kaesong si|Kangwon do|Nampo si|Pyongan bukto|Pyongan namdo|Pyongyang si |Yanggang do";
...
s_a[127] = "Batken Oblasty|Bishkek |Bishkek Shaary|Jalal Abad Oblasty|Naryn Oblasty|Osh Oblasty|Talas Oblasty|Ysyk Kol Oblasty";
...
s_a[149] = "Agalega|Black River|Cargados Carajos Shoals|Flacq|Grand Port|Moka|Pamplemousses|Plaines Wilhems|Port Louis|Riviere du Rempart|Rodrigues|Savanne";
s_a[150] = "Mayotte";
s_a[151] = "Aguascalientes|Baja California|Baja California Sur|Campeche|Chiapas|Chihuahua|Coahuila de Zaragoza|Colima|Distrito Federal|Durango|Guanajuato|Guerrero|Hidalgo|Jalisco|Mexico|Michoacan de Ocampo|Morelos|Nayarit|Nuevo Leon|Oaxaca|Puebla|Queretaro|Quintana Roo|San Luis Potosi|Sinaloa|Sonora|Tabasco|Tamaulipas|Tlaxcala|Veracruz Llave|Yucatan|Zacatecas";
s_a[152] = "Chuuk|Kosrae|Pohnpei|Yap";
...
s_a[166] = "Akaroa|Amuri|Ashburton|Bay of Islands|Bruce|Buller|Chatham |Cheviot|Clifton|Clutha|Cook|Dannevirke|Egmont|Eketahuna|Ellesmere|Eltham|Eyre|Featherston|Franklin|Golden Bay|Great Barrier Island|Grey|Hauraki Plains|Hawera|Hawkes Bay|Heathcote|Hikurangi|Hobson|Hokianga|Horowhenua|Hurunui|Hutt|Inangahua|Inglewood|Kaikoura|Kairanga|Kiwitea|Lake|Mackenzie|Malvern|Manaia|Manawatu|Mangonui|Maniototo|Marlborough|Masterton|Matamata|Mount Herbert|Ohinemuri|Opotiki|Oroua|Otamatea|Otorohanga|Oxford|Pahiatua|Paparua|Patea|Piako|Pohangina|Raglan|Rangiora|Rangitikei|Rodney|Rotorua|Runanga|Saint Kilda|Silverpeaks|Southland|Stewart|Stratford|Strathallan|Taranaki|Taumarunui|Taupo|Tauranga|Thames Coromandel|Tuapeka|Vincent|Waiapu|Waiheke|Waihemo|Waikato|Waikohu|Waimairi|Waimarino|Waimate|Waimate West|Waimea|Waipa|Waipawa|Waipukurau|Wairarapa South|Wairewa|Wairoa|Waitaki|Waitomo|Waitotara|Wallace|Wanganui|Waverley|Westland|Whakatane|Whangarei|Whangaroa|Woodville";
...
s_a[172] = "Northern|Rota|Saipan|Tinian";
...
s_a[176] = "Aimeliik|Airai|Angaur|Hatobohei|Kayangel|Koror|Melekeok|Ngaraard|Ngarchelong|Ngardmau|Ngatpang|Ngchesar|Ngeremlengui|Ngiwal|Palau |Peleliu|Sonsoral|Tobi";
...
s_a[179] = "Alto Paraguay|Alto Parana|Amambay|Asuncion|Boqueron|Caaguazu|Caazapa|Canindeyu|Central|Concepcion|Cordillera|Guaira|Itapua|Misiones|Neembucu|Paraguari|Presidente Hayes|San Pedro";
...
s_a[184] = "Azores|Aveiro|Beja|Braga|Braganca|Castelo Branco|Coimbra|Evora|Faro|Guarda|Leiria|Lisboa|Madeira|Portalegre|Porto|Santarem|Setubal|Viana do Castelo|Vila Real|Viseu";
...
s_a[189] = "Adygeya|Aginskiy Buryatskiy|Altay|Altayskiy|Amurskaya|Arkhangelskaya|Astrakhanskaya|Bashkortostan|Belgorodskaya|Bryanskaya|Buryatiya|Chechnya |Chelyabinskaya|Chitinskaya|Chukotskiy|Chuvashiya|Dagestan|Evenkiyskiy|Ingushetiya|Irkutskaya|Ivanovskaya|Kabardino Balkariya|Kaliningradskaya|Kalmykiya |Kaluzhskaya|Kamchatskaya|Karachayevo Cherkesiya|Kareliya|Kemerovskaya|Khabarovskiy|Khakasiya|Khanty Mansiyskiy|Kirovskaya|Komi|Komi Permyatskiy |Koryakskiy |Kostromskaya|Krasnodarskiy|Krasnoyarskiy|Kurganskaya|Kurskaya|Leningradskaya|Lipetskaya|Magadanskaya|Mariy El|Mordoviya|Moskovskaya|Moscow|Murmanskaya|Nenetskiy |Nizhegorodskaya|Novgorodskaya|Novosibirskaya|Omskaya|Orenburgskaya|Orlovskaya|Penzenskaya|Permskaya|Pskovskaya|Rostovskaya|Ryazanskaya|Sakha |Sakhalinskaya |Samarskaya|Saint Petersburg|Saratovskaya|Severnaya Osetiya Alaniya |Smolenskaya|Stavropolskiy|Sverdlovskaya|Tambovskaya|Tatarstan|Taymyrskiy|Tomskaya|Tulskaya|Tverskaya|Tyumenskaya|Tyva|Udmurtiya|Ulyanovskaya|Ust Ordynskiy Buryatskiy|Vladimirskaya|Vladivostok|Volgogradskaya|Vologodskaya|Voronezhskaya|Yamalo Nenetskiy|Yaroslavskaya|Yevreyskaya";
...
s_a[199] = "Asir|Al Bahah|Al Hudud ash Shamaliyah|Al Jawf|Al Madinah|Al Qasim|Ar Riyad|Ash Sharqiyah|Hail|Jizan|Makkah|Najran|Tabuk";
s_a[200] = "Aberdeen City|Aberdeenshire|Angus|Argyll and Bute|City of Edinburgh|Clackmannanshire|Dumfries and Galloway|Dundee City|East Ayrshire|East Dunbartonshire|East Lothian|East Renfrewshire|Eilean Siar|Falkirk|Fife|Glasgow City|Highland|Inverclyde|Midlothian|Moray|North Ayrshire|North Lanarkshire|Orkney |Perth and Kinross|Renfrewshire|Shetland Islands|South Ayrshire|South Lanarkshire|Stirling|The Scottish Borders|West Dunbartonshire|West Lothian";
...
s_a[207] = "Bellona|Central|Choiseul|Guadalcanal|Honiara|Isabel|Makira|Malaita|Rennell|Temotu|Western";
...
s_a[210] = "Bird Island|Bristol|Clerke Rocks|Montagu|Saunders|South Georgia|Southern Thule|Traversay";
s_a[211] = "Andalucia|Aragon|Asturias|Balearic|Canary |Cantabria|Castilla y Leon|Castilla La Mancha|Cataluna|Ceuta|Communidad Valencian|Extremadura|Galicia|Islas Chafarinas|La Rioja|Madrid|Melilla|Murcia|Navarra|Pais Vasco|Penon de Alhucemas|Penon de Velez de la Gomera";
s_a[212] = "Spratly";
...
s_a[224] = "Amnat Charoen|Ang Thong|Bangkok|Buriram|Chachoengsao|Chai Nat|Chaiyaphum|Chanthaburi|Chiang Mai|Chiang Rai|Chon Buri|Chumphon|Kalasin|Kamphaeng Phet|Kanchanaburi|Khon Kaen|Krabi|Lampang|Lamphun|Loei|Lop Buri|Mae Hong Son|Maha Sarakham|Mukdahan|Nakhon Nayok|Nakhon Pathom|Nakhon Phanom|Nakhon Ratchasima|Nakhon Sawan|Nakhon Si Thammarat|Nan|Narathiwat|Nong Bua Lamphu|Nong Khai|Nonthaburi|Pathum Thani|Pattani|Phangnga|Phatthalung|Phayao|Phetchabun|Phetchaburi|Phichit|Phitsanulok|Phra Nakhon Si Ayutthaya|Phrae|Phuket|Prachin Buri|Prachuap Khiri Khan|Ranong|Ratchaburi|Rayong|Roi Et|Sa Kaeo|Sakon Nakhon|Samut Prakan|Samut Sakhon|Samut Songkhram|Sara Buri|Satun|Sing Buri|Sisaket|Songkhla|Sukhothai|Suphan Buri|Surat Thani|Surin|Tak|Trang|Trat|Ubon Ratchathani|Udon Thani|Uthai Thani|Uttaradit|Yala|Yasothon";
s_a[225] = "Tobago";
...
s_a[240] = "Andijon Wiloyati|Bukhoro Wiloyati|Farghona Wiloyati|Jizzakh Wiloyati|Khorazm Wiloyati|Namangan Wiloyati|Nawoiy Wiloyati|Qashqadaryo Wiloyati|Qoraqalpoghiston|Samarqand Wiloyati|Sirdaryo Wiloyati|Surkhondaryo Wiloyati|Toshkent Shahri|Toshkent Wiloyati";
...
function print_country(country_id, selectedCountry, selectedState) {
  ...
  if (country == "") {
    ...
    print_state('state', country_arr.indexOf(country) + 1, state);
  }
...
function print_state(state_id, state_index, selectedState) {
  var state = selectedState;
...
/***/ 4:
/*!************************************************************!*\
  !*** multi ./resources/assets/js/modules/countryStates.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp5.6\htdocs\framework\resources\assets\js\modules\countryStates.js */"./resources/assets/js/modules/countryStates.js");
