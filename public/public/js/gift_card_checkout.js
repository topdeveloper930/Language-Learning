...
/***/ "./resources/assets/js/page/gift_card_checkout.js":
/*!********************************************************!*\
  !*** ./resources/assets/js/page/gift_card_checkout.js ***!
  \********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_toaster__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/toaster */ "./resources/assets/js/modules/toaster.js");
/* harmony import */ var _mixins_errorsMixin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/errorsMixin */ "./resources/assets/js/mixins/errorsMixin.js");
...
var app = new Vue({
  el: '#root',
  mixins: [_mixins_errorsMixin__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    return {
      validate: validate,
      toaster: new _modules_toaster__WEBPACK_IMPORTED_MODULE_0__["default"]({}),
      country: 'USA',
      state: 'New York',
      city: '',
      paymentType: '',
  ...
  computed: {
    submitText: function submitText() {
      return 'paypal' === this.paymentMethod ? this.sh.__('pay_paypal') : this.sh.__('purchase_classes');
    }
  },
  methods: {
    ...
    isGoodToSubmit: function isGoodToSubmit() {
      ...
      window.axios.post(ajax_url, {
        ...
        if ('stripe' === self.paymentMethod) {
          ...
          stripe.redirectToCheckout({
            ...
            return self.errors(e.error.message);
          });
  ...
  mounted: function mounted() {
    ...
    if (this.country) this.regionsTypeahead();
  }
});
...
/***/ 2:
/*!**************************************************************!*\
  !*** multi ./resources/assets/js/page/gift_card_checkout.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp5.6\htdocs\framework\resources\assets\js\page\gift_card_checkout.js */"./resources/assets/js/page/gift_card_checkout.js");
