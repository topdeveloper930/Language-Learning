...
/* harmony import */ var _mixins_errorInputMixin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/errorInputMixin */ "./resources/assets/js/mixins/errorInputMixin.js");
...
var app = new Vue({
  el: '#root',
  mixins: [_mixins_errorInputMixin__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    return {
      validate: validate,
