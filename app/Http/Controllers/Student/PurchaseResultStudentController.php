...
class PurchaseResultStudentController extends StudentController
{
	protected $js = [ 'stripe_sdk', 'purchase_result' ];
	...
	/**
	 * Performs confirm|cancel procedures for instant payment methods (PayPal and Stripe).
	 *
	 * Only "Pending" transaction to process.
	 */
