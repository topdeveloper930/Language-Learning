...
class ClassChanged extends Lesson
{
    /**
    ...
    public function toMail( $notifiable )
    {
    	...
    	if ( 'student' == $role ) {
		    ...
		    $translate_path = 'emails.class_changed.teacher.';
		    $translate_path .= ( 'student' === $this->_by ) ? 'student' : 'admin';
		    $line2 = __( 'emails.class_scheduled_remark.teacher' );
	    }

	    $line1 = ( 'student' === $role )
		    ? __( 'emails.class_changed.student', [ 'teacher' => $teacher->accost() . ' (' . $teacher->email . ')', 'dt' => $student->formatUTCtoMyTimeZone( $this->event->eventStart, 'l, F jS \a\t g:i A' ) ] )
        ...
        return ( new MailMessage )
	        ...
	        ->subject( __( 'emails.subject.' . $role . '.class_changed', [ 'date' => $date, 'student' => $student->accost() ] ) )
	        ->line( $line1 )
	        ->line( $line2 );
    }
}
